...
public class IdiomasController {
	...
	public String getIndex(Model model) {
		...
		fechaFin = LocalDate.of(2022, 5, 16);
		...
		fechaFin = LocalDate.of(2022, 4, 1);
		...
		fechaFin = LocalDate.of(2022, 7, 5);
		...
		// Cuarto objeto
		fechaInicio = LocalDate.of(2022, 3, 5);
		fechaFin = LocalDate.of(2022, 4, 5);
		...
		cursosDisponibles.add(curso);
		// Quinto objeto
		fechaInicio = LocalDate.of(2022, 6, 10);
		fechaFin = LocalDate.of(2022, 11, 15);
